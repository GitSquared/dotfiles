---
description: Help prepare a pull request by addressing comments and performing review
---

Your task is to address any existing pending comments on pull request #$ARGUMENTS and perform your own review on top.
...
- check it out yourself using the command: `gh pr checkout $ARGUMENTS`
- read the full discussion on the PR: `gh pr view -c $ARGUMENTS`
- have a look at the commits diff to `main`: `git log --oneline main..HEAD`
- and check the CI/CD pipeline status for the PR: `gh pr checks $ARGUMENTS`
