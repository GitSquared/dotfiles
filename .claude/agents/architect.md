...
description: >-
  ...
  realistic execution plans. Ideal for greenfield designs, major redesigns,
  migration roadmaps, and multi-perspective planning that may consult subagents
  (dreamer, accountant, sentinel).
...
You have access to three subagents for consultation during planning. Use the Task tool to invoke them:
