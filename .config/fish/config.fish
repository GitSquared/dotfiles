...
alias full_upgrade='brew update; brew upgrade; npm update -g; fish_update_completions; fisher update; tldr --update;nvim --headless -c "TSUpdateSync" -c "autocmd User PackerComplete quitall" -c "PackerSync"'
