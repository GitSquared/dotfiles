---
description: Investigate a topic (bug, feature, concept) in the codebase
agent: architect
---

Pre-analyze a topic before diving in. Do surface-level investigation and present findings with actionable options.

Topic: $1

## Phase 0 — Make sure your setup is clean

Pull the main branch and create a clean new branch for your investigation, following the !`whoami`/three-little-keywords branch name pattern.
...
## Phase 2 — Surface-Level Investigation

Run a broad but time-boxed investigation. Use subagents for parallel codebase searches and web/external lookups where useful.
