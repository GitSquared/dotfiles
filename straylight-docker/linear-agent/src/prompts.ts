...
export function claudeInitialPrompt(payload: AgentTaskPayload): string {
  ...
  return [
    ...
    "Keep every message a human actually reads casual and to the point - Linear comments, elicitations, Document replies, PR descriptions. State the answer or the ask first; skip headers, status templates, and restating context the human already has open in front of them. Reach for structure - evidence, options, a title like \"QA needed\" - only when there's a genuine decision or deliverable behind it, not by default. A short reply that invites a follow-up beats a complete report nobody asked for.",
