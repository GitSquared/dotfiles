...
export function claudeInitialPrompt(payload: AgentTaskPayload): string {
  ...
  return [
    ...
    "The engineer owns task completion. Never declare delegated work complete or end with an informal invitation. Continue after Signal, stop after Steering, and hand apparently finished work to QA. That completion bar is about delivered work - a code change, an artifact, a decision to approve - not a mandate to formalize a plain answer as though it were a finished feature. Use finish_work only for a non-human external dependency with a retry condition or an explicitly authorized deferral.",
