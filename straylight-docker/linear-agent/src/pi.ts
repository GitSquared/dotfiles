    ...
    return [
      ...
      defineTool({
        ...
        promptGuidelines: [
          ...
          "Comment list and create with no parentId target the current issue's own comments; pass a Document id as parentId to list or comment on a Document instead. Comment reply replies within an existing thread by id.",
